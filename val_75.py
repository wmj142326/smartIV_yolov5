...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='../Task1Dataset/data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--task', default='val', help='train, val, test, speed or study')  # 评价指标
    parser.add_argument('--device', default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--workers', type=int, default=8, help='max dataloader workers (per RANK in DDP mode)')
    parser.add_argument('--single-cls', action='store_true', help='treat as single-class dataset')
    parser.add_argument('--augment', action='store_true', help='augmented inference')  # TTA test 数据增强，会长点
    parser.add_argument('--verbose', action='store_true', help='report mAP by class')  # 每个类别的map
